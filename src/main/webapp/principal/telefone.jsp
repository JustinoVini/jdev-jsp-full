									...
									<div class="page-body">
										...
										<div style="height: 300px; overflow: scroll;">
											<table class="table" id="tabela-resultados-view">
												...
												<tbody>
													<c:forEach items="${modelTelefones}" var="tel">
														<tr>
															<td><c:out value="${tel.id}"></c:out></td>
															<td><c:out value="${tel.numero}"></c:out></td>
															<td><a class="btn btn-danger"
																href="<%= request.getContextPath() %>/ServletTelefoneController?acao=excluir&id=${tel.id}&usuariopai=${modelLogin.id}">Excluir</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
