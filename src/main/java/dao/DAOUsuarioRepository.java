...
import dto.BeanDtoGraficoSalarioUser;
...
public class DAOUsuarioRepository {
	...
	public List<ModelLogin> consultaUsuarioListRel(Long userLogado) throws Exception {
		...
		while (resultado.next()) { /* percorrer as linhas de resultado do SQL */
			...
			modelLogin.setTelefones(listaTelefone(modelLogin.getId()));
	...
	public List<ModelLogin> consultaUsuarioListRelPorData(Long userLogado, String dataInicial, String dataFinal) throws Exception {
