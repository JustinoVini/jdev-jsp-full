...
public class ReportUtil implements Serializable {
	...
	public byte[] geraRelatorioExcel(List listaDados, String nomeRelatorio, HashMap<String, Object> params, ServletContext servletContext) throws Exception {
		...
		/*Cria a lista de dados que vem do SQL da consulta já feita*/
		...
		JRExporter export = new JRXlsExporter();
		
		export.setParameter(JRExporterParameter.JASPER_PRINT, impressoraJasper);
